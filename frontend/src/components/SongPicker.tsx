    ...
    >
      <div className="setlist-add-content">
        ...
        <div className="song-grid">
          {songs.length === 0 ? (
            <div className="empty">
              <div className="empty-text">{t('songs.noPublicSongs')}</div>
            </div>
          ) : (
            songs.map((s) => (
              <div key={s.id} className="song-picker-item" style={{ display: 'contents' }}>
                <div
                  ...
                  style={
                    expandedId === s.id ? { borderColor: 'var(--accent)', boxShadow: '0 0 0 1px var(--accent)' } : {}
                  }
                >
                    ...
                    <div className="song-card-meta">
                      ...
                      {s.version_count && s.version_count > 1 && (
                        <span
                          ...
                          style={{ marginLeft: 8, background: 'var(--accent-alt)', color: 'white', fontSize: 10 }}
                        >
                ...
                {expandedId === s.id && (
                  <div
                    className="song-card version-list-card"
                    style={{
                      gridColumn: '1 / -1',
                      marginTop: -12,
                      padding: '12px 16px',
